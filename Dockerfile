...
ENV N_m3u8DL-RE="/app/linux/N_m3u8DL-RE_v0.3.0-beta_linux-x64/N_m3u8DL-RE"
...
# Make sure N_m3u8DL-RE is executable
#RUN chmod +x /app/linux/N_m3u8DL-RE_Beta_linux-x64/N_m3u8DL-RE
